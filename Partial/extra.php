                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="" method="POST" id="delchef">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="chef.php" method="POST" id="add-chef-form" enctype="multipart/form-data">
                                                        <div class="mb-3">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control" name="image-edit" id="image-edit" placeholder="Rs.">
                                                        </div>
                                                        <div>
