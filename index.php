...
if (isset($_POST["submit"])) {
    ...
    if (empty($name)) {
        ...
        $object->Add_data('reservation_tbl', $order_add);
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            ...
                            ?>
                                <li class="submenu">
                                    <a href="#">Log in as: <?php echo $_SESSION['key'] ?></a>
                                    <ul>
                    ...
                    <div class="col-lg-4">
                        <div class="chef-item">
                            <div class="thumb">
                                ...
                                <img src="<?php echo $data['image'] ?>" alt="Chef #1">
                            </div>
                            <div class="down-content">
                                <h4><?php echo $data['name'] ?></h4>
                                <span><?php echo $data['speciality'] ?></span>
                            </div>
                        </div>
                    </div>
                <?php
                    ...
                    <div class="contact-form">
                        <form id="contact" action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <fieldset>
                                        <button type="submit" id="form-submit" name="submit" class="main-button-icon">Make A Reservation</button>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
